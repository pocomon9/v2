...
log = logging.getLogger("poco.selenium")
...
class SeleniumController:
    ...
    def warmup(self) -> None:
        ...
        try:
            ...
            search.send_keys(random.choice(["stylegraphy", "vogue", "makeup tutorial", "ollama"]))
        ...
        try:
            ...
            if requested_media:
                for media_path in requested_media:
                    ...
                    try:
                        env_name = "poco_VIDEO_UPLOAD_READY_TIMEOUT" if media_path.suffix.lower() in video_suffixes else "poco_IMAGE_UPLOAD_READY_TIMEOUT"
